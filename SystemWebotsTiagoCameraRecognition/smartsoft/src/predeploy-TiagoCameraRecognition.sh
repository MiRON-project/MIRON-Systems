#!/bin/bash
#
# This script is run prior to deployment of component TiagoCameraRecognition
...
source $REFERENCED_PROJECT_ComponentWebotsCameraRecognition/smartsoft/src/predeploy.sh
