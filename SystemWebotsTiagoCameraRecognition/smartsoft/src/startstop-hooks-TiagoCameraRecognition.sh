#!/bin/bash
#
# Start-Stop-Hooks for component TiagoCameraRecognition
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsCameraRecognition.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsCameraRecognition.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsCameraRecognition.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsCameraRecognition.sh post-stop
