#!/bin/bash
#
# This script is run prior to deployment of component ComponentWebotsObjectRecognition
...
source $REFERENCED_PROJECT_ComponentWebotsObjectRecognition/smartsoft/src/predeploy.sh
