#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsPlanner
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsPlanner.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPlanner.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPlanner.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsPlanner.sh post-stop
