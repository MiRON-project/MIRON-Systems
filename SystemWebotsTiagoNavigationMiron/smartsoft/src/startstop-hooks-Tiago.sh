#!/bin/bash
#
# Start-Stop-Hooks for component Tiago
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsRobot.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsRobot.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsRobot.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsRobot.sh post-stop
