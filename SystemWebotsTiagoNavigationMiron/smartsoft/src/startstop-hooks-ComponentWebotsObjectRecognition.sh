#!/bin/bash
#
# Start-Stop-Hooks for component ComponentWebotsObjectRecognition
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentWebotsObjectRecognition.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObjectRecognition.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObjectRecognition.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentWebotsObjectRecognition.sh post-stop
