#!/bin/bash
#
# Start-Stop-Hooks for component QoSMetricProvider
#
...
pre-start)
	...
	bash startstop-hooks-component-QoSMetricProvider.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-QoSMetricProvider.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-QoSMetricProvider.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-QoSMetricProvider.sh post-stop
